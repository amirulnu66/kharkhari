            ...
            <div class="container footer-toper">
                <div class="footer-col col-md-3 col-sm-3 about" style="padding-right: 0">
                    <div class="footer-col-inner">
                        <h4 class="makeBold ft-title">ক্যালেন্ডার</h4>
                    ...
                    <div class="footer-col-inner ">
                        <h4 class="makeBold ft-title">
                           ...
                           <p style="padding-left:5px;"><a href="http://www.ntrca.gov.bd" target="_blank">   <i class="fa fa-caret-right" style="padding-left:5px;"> &nbsp;বেসরকারি শিক্ষক নিবন্ধন ও প্রত্যয়ন কর্তৃপক্ষ (এনটিআরসিএ) </i></a></p>                            
                            ...
                            <!--old link-->
                             <p style="padding-left:5px;"><a href="http://www.rajshahieducationboard.gov.bd/" target="_blank">   <i class="fa fa-caret-right" style="padding-left:5px;">&nbsp; রাজশাহী শিক্ষা বোর্ড</i></a></p>                             
                    ...
                    <div class="footer-widget mb-30">
                        ...
                        @if(!empty(settingsInfo()))
                            <ul class="list-style-one">
                                ...
                                <li><span class="icon fa fa-globe"></span>khsr.edu.bd</li><br>
                                <li class="total-visitor">Total Visitor:&nbsp;
                                    <a href="/" target="_blank" title="Visitor Counter">
                                        <img src="https://smallseotools.com/counterDisplay?code=bd2a39b0c070c6ab6121216dcb300fd0&style=0014&pad=6&type=page&initCount=100"  title="Visitor Hit Counter" Alt="Visitor Hit Counter" border="0">
                                        </a>
                        ...
                        <div class="copyright col-md-5" style="float: left;">
                            <p>
                                Copyright @ 2018,<a href="/" target="_blank">
                                    <span id="lblCopyRightSchoolName" class="copyrightSclName">Khar Khari High School, Rajshahi</span></a></p>
                        </div>
                        <div class="col-md-3" style="text-align: center;">
                            <p style="margin-top: 0;">
                                <!-- <span id="Label1">Total Visitor:</span>
                                <span id="lblVisitorCounter" class="visitorCount">1844</span> -->
                            </p>
                            <p>
                                <span id="lblIPAdd" class="label label-info"></span>
                            </p>
                        </div>
