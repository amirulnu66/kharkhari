<section class="links">
            <h1 class="section-heading text-highlight rightbar-link-bg">
                <span class="line"> গুরুত্বপূর্ণ লিংক</span></h1>
                    <div id="QuickLinksDiv" class="section-content" style="min-height: 140px;">
                           ...
                           <p style="padding-left:5px;"><a href="http://www.ntrca.gov.bd" target="_blank">   <i class="fa fa-caret-right" style="padding-left:5px;"> বেসরকারি শিক্ষক নিবন্ধন ও প্রত্যয়ন কর্তৃপক্ষ (এনটিআরসিএ) </i></a></p>                            
                            ...
                            <!--old link-->
                             <p style="padding-left:5px;"><a href="http://www.rajshahieducationboard.gov.bd/" target="_blank">   <i class="fa fa-caret-right" style="padding-left:5px;"> রাজশাহী বোর্ড</i></a></p> 
                             <p style="padding-left:5px;"><a href="http://www.bteb.gov.bd/" target="_blank">   <i class="fa fa-caret-right" style="padding-left:5px;"> বাংলাদেশ কারিগরি শিক্ষা বোর্ড</i></a></p>
